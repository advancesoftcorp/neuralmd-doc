...
.. option:: --que
 ...
 --flexオプションとの併用はLinuxでのみ可能です。

.. option:: --flex

 従来のFlexNetのライセンスを使用して計算を実行します。

 このオプションを指定しない場合、Sentinelのライセンスを使用して計算を実行します。

 このオプションはバージョン2.1以降に廃止されますので、お早めにライセンスをFlexNetからSentinelに更新してください。
